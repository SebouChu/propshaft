...
## Upgrading from Sprockets

Check the [upgrade guide](https://github.com/rails/propshaft/blob/main/UPGRADING.md) for step-by-step instructions on how to upgrade an existing project to propshaft.
